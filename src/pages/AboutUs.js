...
const Login = () => {
 ...
 <h1 style={{color:"var(--background2)",textAlign:"center",fontWeight:"700",fontFamily:"Freight Big Pro",fontSize:"48px",fontStyle:"normal",letterSpacing:"-0.96px",lineHeight:"normal"}}>Our Journey in the World of Rare Whiskey NFTs
</h1>
 <p style={{color:"white",textAlign:"center" ,marginTop:"2%",marginBottom:"5%"}}>A passion for rare whiskey and cutting-edge technology brought us together to create the ultimate platform for whiskey enthusiasts and collectors.
    ...
    <div style={{width:"50%"}}>
        ...
        <h1 style={{color:"var(--background2)",fontWeight:"700",fontFamily:"Freight Big Pro",fontSize:"48px",fontStyle:"normal",letterSpacing:"-0.96px",lineHeight:"normal"}}>Introduction
    </h1>
    <p style={{color:"white"}}>Founded in 2022, [Your Company Name] is dedicated to revolutionizing the rare whiskey market by offering a secure and user-friendly platform for buying, selling, and storing NFT-backed whiskey bottles. Our team combines extensive industry knowledge with technological expertise to deliver an unparalleled experience for whiskey aficionados worldwide.</p>
<Button
                style={{
                  color: "white",
    ...
    {/* our mission */}
    <div style={{ width:"100%"  ,background:"var(--background)",padding:"5%",paddingBottom:"8%"}}> 
    <p style={{color:"#F4F5F6",textAlign:"center",fontSize:"0.8rem"}}>ABOUT US
</p>
 <h1 style={{color:"var(--background2)",textAlign:"center",fontWeight:"700",fontFamily:"Freight Big Pro",fontSize:"48px",fontStyle:"normal",letterSpacing:"-0.96px",lineHeight:"normal"}}>Our Mission 
</h1>
 ...
 <h1 style={{color:"var(--background2)",textAlign:"center",fontWeight:"700",fontFamily:"Freight Big Pro",fontSize:"48px",fontStyle:"normal",letterSpacing:"-0.96px",lineHeight:"normal"}}>Our Team
</h1>
 <p style={{color:"white",textAlign:"center" ,marginTop:"2%",marginBottom:"5%"}}>"Empowering whiskey enthusiasts to discover, invest, and savor the world of rare whiskey NFTs."
...
{/* our achievements */}
    ...
    <div style={{width:"50%"}}>
        ...
        <h1 style={{color:"var(--background2)",fontWeight:"700",fontFamily:"Freight Big Pro",fontSize:"48px",fontStyle:"normal",letterSpacing:"-0.96px",lineHeight:"normal"}}>Our Achievements
    </h1>
...
<ul   style={{color:"white"}}>
    ...
    <img width={350} src='/images/about2.png' />
      ...
      <div style={{ width:"100%"  ,background:"var(--background)",padding:"4%",paddingBottom:"8%"}}> 
    <p style={{color:"white",textAlign:"center",fontSize:"0.8rem"}}>ABOUT US
</p>
 <h1 style={{color:"var(--background2)",textAlign:"center",fontWeight:"700",fontFamily:"Freight Big Pro",fontSize:"48px",fontStyle:"normal",letterSpacing:"-0.96px",lineHeight:"normal"}}>Our Future
</h1>
 <p  style={{color:"white",width:"850px",textAlign:"center",marginLeft:"220px" ,marginTop:"2%",marginBottom:"5%"}}>As we continue to grow and evolve, [Your Company Name] remains committed to delivering a seamless and secure experience for our users. We are constantly exploring new ways to enhance our platform, expand our offerings, and foster a thriving community of whiskey collectors and enthusiasts.
</p>
...
<div style={{padding:"5%"}}>
<h1 style={{color:"var(--background2)",marginLeft:"165px",width:"890px",textAlign:"center",fontWeight:"700",fontFamily:"Freight Big Pro",fontSize:"48px",fontStyle:"normal",letterSpacing:"-0.96px",lineHeight:"normal"}}>Join us in our journey to redefine the world of rare whiskey NFTs. 
</h1>
<Button
                style={{
