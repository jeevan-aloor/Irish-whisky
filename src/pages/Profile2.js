...
const Profile = () => {
  ...
  const fetchUserFollowing = async () => {
    let { data }=await axios.post(`${API_URL}/check-user-following/${userName.name}/${loggedUser._id}`)
    setIsFollow(data)
  }
      ...
      <div>
        ...
        >
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            ...
            >
              <img
                style={{ marginLeft: "25%", marginBottom: "5%" ,width:"100px",height:"100px",borderRadius:"50px" }}
                src={userData && userData.imgpath}
              />{" "}
              <br></br>
              <h4
              ...
              <div style={{ textAlign: "center" }}>
                ...
                {isFollow !== null ? (
                    ...
                    onClick={() => handleFollow(loggedUser._id, userData._id)}
                    >
                ...
                <p style={{ color: "var(--background2)" }}>
                  Member Since {userData && moment(userData.createdAt).format("MMM D, YYYY")}
                </p>
              </div>
            </div>
